...
for each AE criteria can be calculated as in the AE summary vignette.
...
- pagination: there are many AE terms that can not be covered in one page.
Column headers and SOC information needs to be repeated in every page.

In the code below, we count the number of subjects in each AE term by SOC and
treatment group, and we create a new variable `order` and set it as `0` for these counted numbers.
